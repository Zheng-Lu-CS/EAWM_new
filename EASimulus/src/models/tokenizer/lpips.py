...
class LPIPS(nn.Module):
    ...
    def __init__(
        self, vgg_lpips_ckpt_path: str, use_dropout: bool = True, pnet_type="vgg16"
    ):
        super().__init__()
        ...
        if self.pnet_type in ["vgg", "vgg16"]:
            ...
            self.net = resnet(pretrained=True, requires_grad=False)
    ...
    def load_from_pretrained(self) -> None:
        ckpt = get_ckpt_path(
            name="vgg_lpips", root=self.vgg_lpips_ckpt_path
